...
def render_unavailable_page(
    ...
    *,
    ...
    return render_layout(
        ...
        hero_links=[
            (t(language, "webui.unavailable.hero.pipelines"), MONITOR_PATH),
            (t(language, "webui.unavailable.hero.swagger"), "/docs"),
        ],
...
def render_analytics_dashboard_page(
    ...
    *,
    ...
    return render_layout(
        ...
        hero_links=[
            (t(language, "webui.analytics.hero.dashboard_api"), f"{dashboard_definition_path(dashboard_id)}?dataset={dataset}"),
            (t(language, "webui.analytics.hero.filters_api"), f"{ANALYTICS_FILTERS_PATH}?dataset={dataset}"),
            (t(language, "webui.analytics.hero.export_monitor"), f"{MONITOR_EXPORTS_PATH}?dataset={dataset}"),
        ],
        content_html=content_html,
