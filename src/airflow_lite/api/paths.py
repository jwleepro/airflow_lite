...
MONITOR_ADMIN_PATH = f"{MONITOR_PATH}/admin"
MONITOR_ADMIN_CONNECTIONS_PATH = f"{MONITOR_ADMIN_PATH}/connections"
MONITOR_ADMIN_VARIABLES_PATH = f"{MONITOR_ADMIN_PATH}/variables"
MONITOR_ADMIN_POOLS_PATH = f"{MONITOR_ADMIN_PATH}/pools"
MONITOR_ADMIN_PROVIDERS_PATH = f"{MONITOR_ADMIN_PATH}/providers"
MONITOR_ADMIN_PLUGINS_PATH = f"{MONITOR_ADMIN_PATH}/plugins"
MONITOR_ADMIN_CONFIG_PATH = f"{MONITOR_ADMIN_PATH}/config"
MONITOR_ADMIN_XCOMS_PATH = f"{MONITOR_ADMIN_PATH}/xcoms"
...
MONITOR_DAG_RUNS_PATH = MONITOR_BROWSE_DAG_RUNS_PATH
