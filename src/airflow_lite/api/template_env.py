...
def _make_env() -> Environment:
    ...
    env.globals.update(
        ...
        MONITOR_ADMIN_CONNECTIONS_PATH=MONITOR_ADMIN_CONNECTIONS_PATH,
        MONITOR_ADMIN_VARIABLES_PATH=MONITOR_ADMIN_VARIABLES_PATH,
        MONITOR_ADMIN_POOLS_PATH=MONITOR_ADMIN_POOLS_PATH,
        MONITOR_ADMIN_PROVIDERS_PATH=MONITOR_ADMIN_PROVIDERS_PATH,
        MONITOR_ADMIN_PLUGINS_PATH=MONITOR_ADMIN_PLUGINS_PATH,
        MONITOR_ADMIN_CONFIG_PATH=MONITOR_ADMIN_CONFIG_PATH,
        MONITOR_ADMIN_XCOMS_PATH=MONITOR_ADMIN_XCOMS_PATH,
        ...
        MONITOR_SECURITY_PATH=MONITOR_SECURITY_PATH,
        MONITOR_SECURITY_USERS_PATH=MONITOR_SECURITY_USERS_PATH,
        MONITOR_SECURITY_ROLES_PATH=MONITOR_SECURITY_ROLES_PATH,
        MONITOR_SECURITY_PERMISSIONS_PATH=MONITOR_SECURITY_PERMISSIONS_PATH,
