...
_TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "webui.run_detail.tab.overview": "Overview",
        "webui.run_detail.tab.steps": "Steps & Timeline",
        ...
        "webui.run_detail.tab.grid": "Grid",
        ...
        "webui.run_detail.tab.graph": "Graph",
    ...
    "ko": {
        ...
        "webui.monitor.title": "DAGs",
        "webui.monitor.subtitle": "Airflow 스타일의 DAG 목록에서 최근 상태 블록, 스케줄, 다음 실행, 실패 문맥을 함께 확인합니다.",
        ...
        "webui.run_detail.tab.overview": "개요",
        "webui.run_detail.tab.steps": "스텝 & 타임라인",
        ...
        "webui.run_detail.tab.graph": "그래프",
