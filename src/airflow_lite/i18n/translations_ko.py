...
"webui.admin.pipelines.partition_note": "Oracle WHERE 절 조각과 bind placeholder를 정의하세요. 기본 bind로 data_interval_start/end 및 각 날짜 구성요소를 제공하며, source_bind_params 로 추가 bind를 선언할 수 있습니다.",
...
"webui.admin.col.source_where_template": "Source WHERE 템플릿",
