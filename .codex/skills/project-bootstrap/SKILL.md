...
description: Bootstrap work in this repository by reading AGENTS.md, PLAN.md, and PROGRESS.md first, then summarizing active scope, blockers, and the safest next task. Use when starting a new Codex thread or when handing the repository to another agent.
---

# Project Bootstrap

Read `AGENTS.md`, then `PLAN.md`, then `PROGRESS.md` before opening unrelated files.
